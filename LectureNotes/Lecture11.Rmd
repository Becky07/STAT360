...
```{r}
library(reticulate)
#commented out to avoid re-doing
#conda_install(packages=c("pandas","scikit-learn")) 
```
...
```{r}
library(reticulate)
#commented out to avoid re-doing every time I knit
#conda_create("r-reticulate") 

#commented out to avoid re-doing
#conda_install("r-reticulate", c("pandas","scikit-learn")) 
```
