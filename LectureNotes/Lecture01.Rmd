...
![Git & GitHub Desktop](git-githubDesktop.png){width=40%}
...
![Github logo](github.png){width=30%}


- **GitHub**, can be divided into the **Git** and the **Hub**. 
  * The ``Git" implies the version control system; atoll which allows developers to keep track of the constant revisions of their code.
...
![Git vs Github](Git-github.png){width=100%}
