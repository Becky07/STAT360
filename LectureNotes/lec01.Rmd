...
- Read textbook section: Names and values https://adv-r.hadley.nz/names-values.html
- Try the corresponding exercises. Solution can be found here: https://advanced-r-solutions.rbind.io/names-and-values.html
- Upcoming topic: Vectors (Ch3) and Subsetting (Ch4)
